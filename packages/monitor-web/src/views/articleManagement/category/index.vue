<template>
  <div class="app-container">
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column prop="name" label="文章类别" />
...
import {categoryCount} from "../../../api/articleManagement";
...
export default {
  ...
  methods: {
    ...
    checkPermission,
    beforeInit() {
      this.url = "/cms/category";
      // const sort = "sort,asc";
      this.params = { offset: this.page*this.size, limit: this.size};
