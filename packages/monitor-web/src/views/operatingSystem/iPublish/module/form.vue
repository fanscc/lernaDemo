  ...
  data: function () {
    return {
      ...
      rules: {
        ...
        area: [{required: true, message: "请选择地块", trigger: "blur"}],
        crop: [{required: true, message: "请选择作物", trigger: "blur"}],
        executor: [{required: true, message: "请选择执行人", trigger: "blur"}],
        work: [{required: true, message: "请选择事件", trigger: "blur"}],
        repeat: [{required: true, message: "请选择循环方式", trigger: "blur"}],
        // remark: [{required: true, message: "请输入备注", trigger: "blur"}],
        // creator: [{required: true, message: "请输入创建人", trigger: "blur"}],
        day: [{required: true, message: "请选择日期或星期", trigger: "blur"}],
